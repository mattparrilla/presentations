...
[Component Lifecycle Documentation](https://facebook.github.io/react/docs/react-component.html#the-component-lifecycle)
...
## unmount
called once prior to component being removed from DOM
...
If you think of your application as a pure function, state are your inputs.
State is the minimum amount of information needed to render your app.
...
To do that, hoist it up to lowest common component
